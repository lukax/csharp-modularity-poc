    ...
    public class Navigator : INavigator
    {
        ...
        public INavigator ResolveView(string param, object viewModel = null)
        {
            if (viewModel == null)
                ...
                {
                    case "AlterProduct":
                        _resolvedView = _container.Resolve<AlterProductView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "AlterLegalPerson":
                        _resolvedView = _container.Resolve<AlterLegalPersonView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "AlterNaturalPerson":
                        _resolvedView = _container.Resolve<AlterNaturalPersonView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "ListProduct":
                        _resolvedView = _container.Resolve<ListProductView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "AlterEmployee":
                        _resolvedView = _container.Resolve<AlterEmployeeView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "ListEmployee":
                        _resolvedView = _container.Resolve<ListEmployeeView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "AlterClient":
                        _resolvedView = _container.Resolve<AlterCustomerView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "ListClient":
                        _resolvedView = _container.Resolve<ListCustomerView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "AlterSale":
                        _resolvedView = _container.Resolve<AlterSaleView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    case "QuickSearch":
                        _resolvedView = _container.Resolve<ListBaseEntityView>(new ParameterOverride("viewModel", viewModel));
                        break;
                    default:
                        throw new ArgumentException("Parameter not implemented yet, ", "param");
                }
