...
namespace LOB.UI.Core.View.Styles.Behaviours {
    /// <summary>
    ...
    public static class GridViewColumnResize {
        ...
        public static readonly DependencyProperty WidthProperty = DependencyProperty.RegisterAttached("Width", typeof(string),
        ...
        public static readonly DependencyProperty GridViewColumnResizeBehaviorProperty =
            DependencyProperty.RegisterAttached("GridViewColumnResizeBehavior", typeof(GridViewColumnResizeBehavior), typeof(GridViewColumnResize),
                                                null);
        ...
        public static readonly DependencyProperty ListViewResizeBehaviorProperty =
            DependencyProperty.RegisterAttached("ListViewResizeBehaviorProperty", typeof(ListViewResizeBehavior), typeof(GridViewColumnResize), null);

        #endregion
        public static string GetWidth(DependencyObject obj) { return (string)obj.GetValue(WidthProperty); }

        public static void SetWidth(DependencyObject obj, string value) { obj.SetValue(WidthProperty, value); }
        ...
        public class GridViewColumnResizeBehavior {
            ...
            public double Percentage {
                get {
                    if(!IsStatic) return Mulitplier*100;
                    return 0;
                }
            }
            ...
            public double Mulitplier {
                get {
                    ...
                    if(Width.EndsWith("*")) {
                        double perc;
                        if(double.TryParse(Width.Substring(0, Width.Length - 1), out perc)) return perc;
                    }
                    return 1;
                }
            }
        ...
        public class ListViewResizeBehavior {
            ...
            private void OnLoaded(object sender, RoutedEventArgs e) { _element.SizeChanged += OnSizeChanged; }
            ...
            private void Resize() {
                if(Enabled) {
                    ...
                    if(gv != null) {
                        ...
                        foreach(GridViewColumnResizeBehavior behavior in GridViewColumnResizeBehaviors(gv)) behavior.SetWidth(allowedSpace, totalPercentage);
                    }
                }
            }
            ...
            private static double GetAllocatedSpace(GridView gv) {
                ...
                foreach(GridViewColumn t in gv.Columns) {
                    ...
                    if(gridViewColumnResizeBehavior != null) {
                        if(gridViewColumnResizeBehavior.IsStatic) totalWidth += gridViewColumnResizeBehavior.StaticWidth;
                    }
                    else totalWidth += t.ActualWidth;
                }
                return totalWidth;
            }
