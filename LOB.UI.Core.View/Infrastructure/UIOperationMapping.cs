...
namespace LOB.UI.Core.View.Infrastructure {
    public static class UIOperationMapping {
        ...
        private static readonly Lazy<IDictionary<UIOperation, Type>> LazyView =
            new Lazy<IDictionary<UIOperation, Type>>(() => new Dictionary<UIOperation, Type> { //Alter
                {
                ...
                //{new UIOperation{ Type = UIOperationType.Address, State = UIOperationState.QuickSearch}, typeof(ListAddressView)},
                {
                    ...
                    new UIOperation {Type = UIOperationType.Category, State = UIOperationState.QuickSearch},
                    typeof(ListCategoryView)
                }, {
                ...
                //{Command.ListPerson, typeof(ListPersonView)},
                {
                    new UIOperation {Type = UIOperationType.PhoneNumber, State = UIOperationState.QuickSearch},
                    typeof(ListPhoneNumberView)
                }, {
                    new UIOperation {Type = UIOperationType.Product, State = UIOperationState.QuickSearch},
                    typeof(ListProductView)
                }, {
                    new UIOperation {Type = UIOperationType.Service, State = UIOperationState.QuickSearch},
                    typeof(ListServiceView)
                },
            });
        ...
        private static readonly Lazy<IDictionary<UIOperation, Type>> LazyViewModel =
            new Lazy<IDictionary<UIOperation, Type>>(() => new Dictionary<UIOperation, Type> { //Alter
                ...
                //{Command.ListNaturalPerson, typeof(ListNaturalPersonViewModel)},
                {
                    new UIOperation {Type = UIOperationType.Op, State = UIOperationState.QuickSearch},
