...
//            {new ViewID {Type = ViewType.BaseEntity, State = ViewState.Add}, typeof(BaseEntityView)},
...
//            {new ViewID {Type = ViewType.BaseEntity, State = ViewState.Update}, typeof(BaseEntityView)},
