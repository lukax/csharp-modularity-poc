...
namespace LOB.Domain.Monetary {
    ...
    public class Currency {
        ...
        public Currency(CurrencyCodes currencyCode) {
            ...
            CultureInfo cultureInfo = CultureInfoFromCurrencyIso(Code);
        ...
        public static Currency Get(CurrencyCodes currencyCode) {
            if(CurrencyDictionary.ContainsKey(currencyCode)) return CurrencyDictionary[currencyCode];
            return null;
        }

        public static bool Exists(CurrencyCodes currencyCode) { return CurrencyDictionary.ContainsKey(currencyCode); }
        ...
        private static CultureInfo CultureInfoFromCurrencyIso(string isoCode) {
            ...
            foreach(CultureInfo ci in CultureInfo.GetCultures(CultureTypes.SpecificCultures)) {
                ...
                if(ri.ISOCurrencySymbol == isoCode) return ci;
            }
        ...
        private static Dictionary<CurrencyCodes, Currency> CreateCurrencyDictionary() {
            return Enum.GetValues(typeof(CurrencyCodes)).Cast<CurrencyCodes>().ToDictionary(code => code, code => new Currency(code));
        }
    }
