...
namespace LOB.Domain.Base {
    ...
    public abstract class BaseNotifyChange : INotifyPropertyChanged {
        ...
        protected internal void OnPropertyChanged([CallerMemberName] string propertyName = null) { if(PropertyChanged != null) PropertyChanged(this, new PropertyChangedEventArgs(propertyName)); }
    }
}