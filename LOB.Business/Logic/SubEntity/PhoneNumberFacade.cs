...
namespace LOB.Business.Logic.SubEntity {
    ...
    public sealed class PhoneNumberFacade : BaseEntityFacade<PhoneNumber>, IPhoneNumberFacade {
        ...
        public override PhoneNumber GenerateEntity() {
            PhoneNumber result = base.GenerateEntity();
            result.Number = "";
        ...
        private void ConfigureValidations() {
            AddValidation(delegate {
                              ...
                              if(!Regex.IsMatch(Entity.Number, @"\d")) return new ValidationResult("Number", Strings.Notification_Field_OnlyNumbers);
                              return null;
                          });
            AddValidation(
                    delegate {
                        return string.IsNullOrWhiteSpace(Entity.Type.ToString())
