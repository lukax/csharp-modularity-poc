...
namespace LOB.Business.Logic.SubEntity
{
    public class ContactInfoFacade : IContactInfoFacade
    {
        ...
        public void ConfigureValidations()
        {
            ...
            if (_entity != null)
            {
                _entity.AddValidation((sender, name) => _entity.WebSite.Length > 300 ? 
                    new ValidationResult("WebSite", Strings.Error_Field_Empty) : null);
            }
        }
        ...
        private bool ProcessBasicValidations(out IEnumerable<ValidationResult> invalidFields)
        {
            ...
            if (fields.Where(validationResult => validationResult != null).Count(validationResult => !string.IsNullOrEmpty(validationResult.ErrorDescription)) > 0)
                return false;
            return true;
        }
